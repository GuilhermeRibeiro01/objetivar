...
ENDPOINT_URL = "https://j9sws97i10.execute-api.us-east-1.amazonaws.com"
...
if st.session_state[PAGE_SELECTION_KEY] == "Empresas":
    ...
    # product_id = st.selectbox("Tipo de seguro", ["Vida", "Automóvel"])
    document_type = st.selectbox("Tipo de Documento", ["pdf", "csv"])



    arquivo = st.file_uploader("Escolha um arquivo", type=['pdf', 'csv'])
